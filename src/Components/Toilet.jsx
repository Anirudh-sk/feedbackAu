...
function Toilet({setWashedRegularly, setWaterSupply, setFlushWorking, setWaterLekage}) {
    return (
        <>
            <Grid item xs={12} >
            ...
            <FormLabel  >Flush Working</FormLabel>
                ...
                <RadioGroup
                    ...
                    aria-labelledby="demo-row-radio-buttons-group-label"
                    name="row-radio-buttons-group"
                    onChange={e => { setFlushWorking(e.target.value) }}
            ...
            <FormLabel  >Water Lekage</FormLabel>
                ...
                <RadioGroup
                    ...
                    aria-labelledby="demo-row-radio-buttons-group-label"
                    name="row-radio-buttons-group"
                    onChange={e => { setWaterLekage(e.target.value) }}
